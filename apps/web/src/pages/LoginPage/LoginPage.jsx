      ...
      <main className={styles.page}>
        <div className={styles.card}>
          ...
          <p className={styles.confirmText}>
            A password reset link was sent to <strong>{email}</strong>. Click it to reset your password.
          </p>
  ...
  return (
    <main className={styles.page}>
      <form className={styles.card} onSubmit={handleSubmit}>
        ...
        {!IS_TAURI && <div className={styles.divider}>or</div>}
        {!IS_TAURI && <button type="button" className={styles.googleBtn} onClick={signInWithGoogle}>
